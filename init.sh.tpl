...
ssh -i csr.pem -o ServerAliveCountMax=10 -o ServerAliveInterval=120 -o LogLevel=DEBUG3 -o StrictHostKeyChecking=no ec2-user@${node1_public_ip} guestshell run pip install csr-aws-ha
