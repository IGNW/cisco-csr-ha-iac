...
ssh -tti csr.pem -o ServerAliveInterval=120 -o ClientAliveInterval=120 -o LogLevel=DEBUG -o LocalCommand="guestshell run pip install csr-aws-ha" -o StrictHostKeyChecking=no ec2-user@${node1_public_ip} guestshell run echo abc123
